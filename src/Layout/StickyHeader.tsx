...
const StickyHeader = ({ searchRef, handleSearchOpen }: HeaderProps) => {
    ...
    return (
        <React.Fragment>
            ...
            <header id="mosso_fn_sticky_header">
                <div className="mosso_fn_sticky_header">
                    <div className="sticky_header_left">
                    ...
                    <div className="sticky_header_middle">
                    ...
                    <div className="sticky_header_right">
