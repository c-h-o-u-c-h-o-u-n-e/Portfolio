                    ...
                    <div className="footer_top">
                        <div className="container">
                            <div className="mosso_fn_subscribe_form">
                                ...
                                <h3 className="title"><span>Stay in The Loop</span></h3>
...
-2429 -17z"/>
                                        ...
                                        <li><Link to="https://facebook.com/" target="_blank">
                                            <svg version="1.0" className='fn__svg' xmlns="http://www.w3.org/2000/svg"
                                                width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000"
                                                preserveAspectRatio="xMidYMid meet">
                                        ...
                                        <li><Link to="https://instagram.com/" target="_blank">
                                            <svg version="1.0" className='fn__svg' xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="copyright">
                                    <p>© 2024 <Link to="#" target="_blank">SRBThemes</Link>. All rights reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
