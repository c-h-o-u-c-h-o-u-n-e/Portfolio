...
const MobileHeadre = ({ searchRef, handleSearchOpen }: HeaderProps) => {
    ...
    return (
        <React.Fragment>
            ...
            <header className={`mosso_fn_mobnav ${menu ? 'menu_opened' : ""}`} >
                <div className="mob_top">
                    <div className="mob_top_left">
	...
	c0.98,1.42,2.09,2.77,3.35,4.03l75.67,75.67c11.28,11.28,29.56,11.28,40.83,0v0C476.19,453.31,476.19,435.02,464.92,423.75z"/>
                        ...
                        <div className="fn__mobile_trigger">
                            <Link to="#" className="fn__icon" onClick={handleMenu}>
                                <span></span>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="mob_bottom_in">
                        <ul role="menu" className="mobile_menu">
                            ...
                            <li className="menu-item-has-children">
                                ...
                                <ul className="sub-menu" onClick={() => setIsSubMenuOpen(true)} style={{ display: isSubMenuopen === true ? "block" : "none" }}>
                                    <li><Link to="/contact" onClick={handleMenu}>Contact</Link></li>
                                    <li><Link to="/account" onClick={handleMenu}>Account</Link></li>
                                    <li><Link to="/404" onClick={handleMenu}>404 Page</Link></li>
                                    <li><Link to="/author" onClick={handleMenu}>Author</Link></li>
                                    <li><Link to="/tag" onClick={handleMenu}>Tag</Link></li>
                                    <li><Link to="/sign-up" onClick={handleMenu}>Sign Up</Link></li>
                                    <li><Link to="/sign-in" onClick={handleMenu}>Sign In</Link></li>
                                    <li><Link to="/single" onClick={handleMenu}>Single</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
