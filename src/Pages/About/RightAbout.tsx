...
import { Details, Eduction, Experience, Testimonials } from '../../Data/RightAboutContant'
                ...
                <div className="about_right_in">
                    ...
                    <section className="section_skills">
                        ...
                        <div className="fn__progress">
                            ...
                            <div className="fn__progress_item" data-percent="79">
                                <div className="progress_label">
                                    <h3 className="title">Javascript</h3>
                                    <span className="percent">79%</span>
                                </div>
                                <div className="progress_bg">
                                    <div className="bg_active" style={{ width: "79%", backgroundColor: "black" }}><span></span></div>
                                </div>
                            </div>
                            <div className="fn__progress_item" data-percent="75">
                                <div className="progress_label">
                                    <h3 className="title">React</h3>
                                    <span className="percent" >75%</span>
                                </div>
                                <div className="progress_bg">
                                    <div className="bg_active" style={{ width: "75%", backgroundColor: "black" }}><span></span></div>
                                </div>
                            </div>
                            <div className="fn__progress_item" data-percent="92">
                                <div className="progress_label">
                                    <h3 className="title">Type Scripting</h3>
                                    <span className="percent" >92%</span>
                                </div>
                                <div className="progress_bg">
                                    <div className="bg_active" style={{ width: "92%", backgroundColor: "black" }}><span></span></div>
                                </div>
                            </div>
                        </div>
                    </section>
